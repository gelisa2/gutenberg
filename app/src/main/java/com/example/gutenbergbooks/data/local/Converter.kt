...
//
////    @TypeConverter
////    fun fromBaseResponse(baseResponse: BaseResponse<*>?): String? {
////        return gson.toJson(baseResponse)
////    }
////
////    // Convert JSON string back to BaseResponse
////    @TypeConverter
////    fun toBaseResponse(baseResponseString: String?): BaseResponse<*>? {
////        return gson.fromJson(baseResponseString, BaseResponse::class.java)
////    }
//
//    @TypeConverter
//    fun fromAuthorsDTOList(authors: List<AuthorsDTO>?): String? {
...
//    @TypeConverter
//    fun toAuthorsDTOList(authorsString: String?): List<AuthorsDTO>? {
//        val listType = object : TypeToken<ArrayList<AuthorsDTO>>() {}.type
//        return gson.fromJson(authorsString, listType)
//    }
//
//    @TypeConverter
